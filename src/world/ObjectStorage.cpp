...
const char * gCreatureDifficultyFormat					= "uuuu";
...
SERVER_DECL SQLStorage<CreatureDifficulty, HashMapStorageContainer<CreatureDifficulty> >      CreatureDifficultyStorage;
...
void Storage_FillTaskList(TaskList & tl)
{
	...
	make_task(CreatureDifficultyStorage, CreatureDifficulty, HashMapStorageContainer, "creature_difficulty", gCreatureDifficultyFormat);
...
void Storage_Cleanup()
{
	...
	CreatureDifficultyStorage.Cleanup();
...
bool LoadAdditionalTable(const char* TableName, const char* SecondName, bool firstLoad = false)
{
	...
	else if (firstLoad && !stricmp(TableName, "creature_difficulty"))        // Creature Difficulty
		CreatureDifficultyStorage.LoadAdditionalData(SecondName, gCreatureDifficultyFormat);
