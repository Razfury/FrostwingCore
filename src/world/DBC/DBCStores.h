...
struct SpellEntry
{
  ...
  //uint32 buffType;                                        /// CUSTOM, these are related to creating a item through a spell
	...
	float ap_override;									   /// CUSTOM, overrides any spell coefficient calculation for attack power
	float ap_dot_override;									   /// CUSTOM, overrides any spell coefficient calculation for attack power dot.
	...
	bool override_cast_check = false;						//Custom used temp for spell bug checks.
    bool noproc;
