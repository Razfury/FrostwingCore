...
class SERVER_DECL Object : public EventableObject
{
	public:
		...
		void SetGossipStatus(uint32 Status);
		const uint32 GetGossipStatus() const { return m_gossipStatus; }
        ...
        bool IsWithinLOS(float nx, float ny, float nz);
