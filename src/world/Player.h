...
class SERVER_DECL Player : public Unit
{
    ...
    public:
		...
		uint32 m_bypassCastRequirements[3];
    ...
    public:
        ...
        Group*      GetGroup() { return m_playerInfo != NULL ? m_playerInfo->m_Group : NULL; }
    ...
    public:
        ...
        ******************/
		...
		void Insert_DB_NewRune(uint32 playerGUID, uint32 cinderglacier = 0, uint32 lichbane = 0, uint32 spellbreaking = 0, uint32 spellshattering = 0, uint32 swordbreaking = 0, uint32 swordshattering = 0, uint32 nerubiancarapace = 0, uint32 razorice = 0, uint32 fallencrusader = 0, uint32 stoneskin = 0);
		bool Has_Rune_Weapon_Enchantment_cinderglacier(uint32 playerGUID);
		bool Has_Rune_Weapon_Enchantment_fallencrusader(uint32 playerGUID);

		//void HandleProcs_Temp(Unit* pVictim, uint32 damage, uint32 targetEvent, uint32 unitEvent, uint32 spellId, bool no_remove_auras = false, bool aura = false);
