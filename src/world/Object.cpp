...
void Object::SetGossipStatus(uint32 Status)
{
	m_gossipStatus = Status;
}
...
bool Object::IsWithinLOS(float nX, float nY, float nZ)
{
    LocationVector location2;
    location2 = GetPosition();
    ...
    if (sWorld.Collision)
    {
        return CollideInterface.CheckLOS(GetMapId(), location2.x, location2.y, location2.z + 2.0f, nX, nY, nZ + 2.0f);
    }
    else
    {
        return true;
