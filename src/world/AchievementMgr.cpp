                ...
                if (achievementCriteria->kill_creature.creatureID == static_cast<uint32>(miscvalue1))
                {
                    switch (achievement->ID)
                    {
                        ...
                        case 1864: // What the Eck?
							...
							if (GetPlayer()->GetDungeonDifficulty() == DUNGEON_HEROIC && GetPlayer()->HasAura(55817)) // It is Heroic difficulty and player has eck residue.
							{
								UpdateCriteriaProgress(achievementCriteria, 1);
							}
							else
                        ...
                        case 2046: // Amber Void
                            ...
                            break;
                        default:
                            if (!IS_INSTANCE(GetPlayer()->GetMapId()) || (GetPlayer()->iInstanceType == DUNGEON_NORMAL))
                            {
