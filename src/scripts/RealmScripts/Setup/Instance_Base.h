...
enum InstanceMode
{
    Mode_Normal     = RAID_10MAN_NORMAL,
    Mode_Heroic     = RAID_25MAN_NORMAL,
    Mode_Normal_10  = RAID_10MAN_NORMAL,
    Mode_Normal_25  = RAID_25MAN_NORMAL,
    Mode_Heroic_10  = RAID_10MAN_HEROIC,
    Mode_Heroic_25  = RAID_25MAN_HEROIC
};
