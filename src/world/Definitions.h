...
enum MAP_NAMES
{
    ...
    OUTLAND_MAP = 530,
    NORTHREND_MAP = 571,
    BLADES_EDGE_ARENA_MAP = 562,
    DALARAN_ARENA_MAP = 617,
    NAGRAND_ARENA_MAP = 559,
    RUINS_OF_LORDAERON_MAP = 572,
    RING_OF_VALOR_MAP = 618,
    HORDE_PVP_BARRACKS_MAP = 450,
    ALLIANCE_PVP_BARRACKS_MAP = 449,
};

enum AREA_NAMES
{
    AREA_HALL_OF_LEGENDS = 2917,
    AREA_CHAMPIONS_HALL = 2918,
};
