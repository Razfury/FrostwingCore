...
typedef std::set<PlayerInfo*> GroupMembersSet_2;
...
class SERVER_DECL Group
{
    public:
		...
		ARCEMU_INLINE GroupMembersSet_2::iterator GetGroupMembersBegin_2(void) { return m_GroupMembers_2.begin(); }
		ARCEMU_INLINE GroupMembersSet_2::iterator GetGroupMembersEnd_2(void)   { return m_GroupMembers_2.end(); }
		...
		uint64 GetGUID2() { return uint64(m_guid); }
    ...
    protected:
		...
		GroupMembersSet_2 m_GroupMembers_2;
        PlayerInfo* m_Leader;
        PlayerInfo* m_Looter;
